        ...
        <div className="flex flex-col items-start gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
          <Link href="/" className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-base font-semibold text-primary sm:text-lg">See where you stand. Plan your next step.</p>
            </div>
          </Link>

          <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-between lg:w-auto lg:justify-end">
            <nav aria-label="Marketing sections" className="flex flex-wrap items-center gap-2 text-sm font-semibold text-muted">
            ...
            <Link href="/dashboard" className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-white">
              Dashboard
            </Link>
          </div>
        </div>
