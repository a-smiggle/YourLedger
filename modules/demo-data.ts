...
export const demoProfile: HouseholdProfile = {
  ...
  assets: [
    ...
    },
    {
      ...
      value: 166000,
      readingDate: seededReadingDate,
      expectedMonthlyContribution: 1320,
    ...
    },
    {
      ...
      value: 92000,
      readingDate: seededReadingDate,
      expectedMonthlyContribution: 880,
      additionalMonthlyContribution: 0,
      annualGrowthRate: 7,
...
const demoScenarios: UserScenario[] = [
  {
    ...
    equityBankId: "major-bank-a",
    equityProductId: "major-bank-a-variable",
    productUsage: "Owner occupier purchase with an offset account kept for emergency cash.",
    propertyTreatment: "equity-release",
    targetPropertyValue: 1180000,
    cashContribution: 60000,
    hasOffsetAccount: true,
    equityReleaseAmount: 180000,
    refinanceExistingLoanAmount: 392000,
    offsetBalance: 24000,
    targetInterestRate: 5.89,
    assessmentBuffer: 3,
    loanTermYears: 30,
  },
  {
    ...
    equityBankId: "major-bank-b",
    equityProductId: "major-bank-b-refi",
    productUsage: "Refinance existing debt and simplify repayments into one principal and interest loan.",
    propertyTreatment: "equity-release",
    targetPropertyValue: 1100000,
    cashContribution: 45000,
    hasOffsetAccount: true,
    equityReleaseAmount: 220000,
    refinanceExistingLoanAmount: 392000,
    offsetBalance: 12000,
  ...
  },
  {
    ...
    equityBankId: "non-bank-lender",
    equityProductId: "non-bank-lender-flex",
    productUsage: "Purchase a new home while keeping extra cash parked in offset instead of paying it down immediately.",
    propertyTreatment: "equity-release",
    targetPropertyValue: 1250000,
